...
public class CraftmanDAO {
    ...
    private final String INSERT_CRAFTMAN = "INSERT INTO `craftman` (`id`, `user_id` , `description`, `experience`) VALUES (NULL, ?, ? , ? )";
    ...
    public Craftman insertCraftman(int user_id, String description, int experience) {
        Connection connection = null;
        PreparedStatement pstm = null;
        ResultSet gk = null;
        ...
        try {
            ...
            if(gk.next()) {
                ...
                craftman.setDescription(description);
                craftman.setExperience(experience);
            }
